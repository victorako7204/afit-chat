...
const FloatingMenu = ({ isOpen, onClose }) => {
  ...
  const items = [
    ...
    { path: '/education', label: 'Educational Hub', icon: 'education' },
  ...
  return (
    <div
      ref={menuRef}
      className={`absolute bottom-16 right-4 z-50 bg-neutral-900/95 text-white p-4 rounded-2xl shadow-xl backdrop-blur-md w-48 transition-all duration-200 origin-bottom-right ${
